...
import toLocalStorage from "./hooks/localStorage";
...
function App() {
  const [products, setProducts] = useState(() =>
    loadLocalStorage(PRODUCTS_LOCAL_STORAGE_KEY, []),
  );
  const [cartItems, setCartItems] = useState(() =>
    loadLocalStorage(CART_ITEMS_LOCAL_STORAGE_KEY, []),
  );

  toLocalStorage(products, PRODUCTS_LOCAL_STORAGE_KEY);
  toLocalStorage(cartItems, CART_ITEMS_LOCAL_STORAGE_KEY);
